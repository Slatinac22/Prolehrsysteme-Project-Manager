          ...
          builder: (context, AsyncSnapshot<Project> snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              return Column(
                ...
                children: [
                  SizedBox(height: 20),
                  _buildDataItem('Ponuda:', project.ponuda, context),
                  SizedBox(height: 10),
                  _buildDataItem('Datum Dobijanja Ponude:', project.datum_dobijanja_ponude, context),
                  SizedBox(height: 10),
                  _buildDataItem('Status Ponude:', project.status_ponude, context),
                ],
              );
            }
          },
