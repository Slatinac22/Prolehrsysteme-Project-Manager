            ...
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              return GridView.count(
                ...
                children: [
                  ...
                  buildButton(context, 'Verifikacija Projekta', VerifikacijaProjektaPage(projectId: updatedProject.id), Colors.teal),
                  buildButton(context, 'Kolicina', KolicinaPage(projectId: updatedProject.id), Colors.indigo),
